...
class Individuos(models.Model):
    ...
    latitud = models.DecimalField ('Latitud',blank=False, default=1,max_digits=19, decimal_places=15)
    longitud = models.DecimalField ('Longitud',blank=False,default=1,max_digits=19, decimal_places=18)
