...
\begin{itemize}
	...
	\imagen{manualProgramador/contraseñaVacia}{Campo contraseña vacío}
	\item \textbf{Usuario vacío}: Si dejamos al iniciar sesión el campo del usuario vacío nos tiene que decir lo siguiente:
	\imagen{manualProgramador/usuarioVacio}{Campo usuario vacío}
	...
	\imagen{manualProgramador/camposIncorrectos}{Campo incorrectos}
	\item \textbf{Email vacío}: Si dejamos al registrarse el campo del email vacío nos tiene que decir lo siguiente:
	\imagen{manualProgramador/emailVacio}{Campo email vacío}
	...
	\imagen{manualProgramador/usuarioValidado}{Usuario no disponible}
	...
	\imagen{manualProgramador/contraseñasDistintas}{Contraseñas distintas}
\end{itemize}